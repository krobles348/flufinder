...
litpeptides_to_masses <- function(aa) {
  ...
  # Looping over each list of peptides and mapping amino acids to masses,
  peptide_masses <- aa
  ...
  # Unlisting the inner lists to generate a list of vectors of masses for
